                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 min-w-[300px] w-full md:w-auto shrink-0 shadow-sm">
                        ...
                        {error && 
                            <div className="flex items-center gap-4">
                                <p className="text-red-500 mt-4 text-center font-medium bg-red-50 p-2 rounded flex-1">{error}</p>
                                <p className="bg-gray-800 hover:bg-black text-white mt-4 text-center font-medium p-2 rounded cursor-pointer" onClick={handelResendOtp}>Resend Otp</p>
                            </div>
                        }
